...
<script type="text/javascript" src="${basePath}/res/js/kk.js"></script>
      ...
      <td height="15" align="left" valign="top" class="12"><table width="100%" height="20" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="20"><div class="right_proaducts">我的位置&gt;&gt;科技项目申报&gt;添加项目类别<br />
              ...
              <form action="addprojectcategory" method="post" id="form" >
                <DIV class=padding>
                <DIV id=middlebody>
                ...
                <table width="400" border="0" align="center" cellpadding="0" cellspacing="1" class="mars">
                  <tbody>
                    ...
                    <tr bgcolor="#e4f1fe">
                      ...
                      <td height="20" colspan="2" align="left" bgcolor="#f3f3f3"><div align="left">
                      <select name="expertid" size="1">
                          <c:forEach items="${um}" var="u">
                            <option value="${u.expertid}">${u.name}</option>
                          </c:forEach>
                      </select>
                      </div></td>
                    </tr>
                    <tr bgcolor="#e4f1fe">
					  ...
					  <input type="date" id="temp2" name="rep_start_time" onFocus="setday(this)"/></td>
                    </tr>
                    <tr bgcolor="#e4f1fe">
                    ...
                    <tr bgcolor="#e4f1fe">
                      ...
                      <td bgcolor="#f3f3f3">&nbsp;</td>
                      <td height="20" colspan="2" align="left" bgcolor="#f3f3f3">
					  <input type="date" id="temp3"  name="rep_stop_time" onFocus="setday(this)" /></td>
                    </tr>
                    <tr bgcolor="#e4f1fe">
