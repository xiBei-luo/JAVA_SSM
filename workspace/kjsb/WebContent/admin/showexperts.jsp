              ...
              <form action="" method="post" id="form">
                ...
                <table class="mars" cellspacing="1" cellpadding="0" width="100%" border="0">
                  <tbody>
                    ...
                    <c:forEach items="${em}" var="u">
                    <tr bgcolor="#e4f1fe">
                      <td bgcolor="#f3f3f3"><div align="center">${u.expertid}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.name}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.unitname}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.title}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.nation}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.sex}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.tel}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center">${u.introduction}</div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><a href="${basePath}/${u.expertid}/expertUpdate">修改</a></div></td>
                      <td bgcolor="#f3f3f3"><div align="center"><a href="${basePath}/${u.expertid}/expertDel">删除</a></div></td>
                    </tr>
                    </c:forEach>
                  </tbody>
                </table>
