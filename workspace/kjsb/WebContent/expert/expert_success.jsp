...
<div id="container" ><div id="content2"><table width="100%" height="41"  border="0" align="center" cellpadding="0" cellspacing="0"><tr><td width="15" height="18" align="left" valign="top"><div align="left"></div></td>
      ...
      <form action="" method="post" id="form"><DIV class=padding><DIV id=middlebody><table cellspacing="0" cellpadding="0" width="100%" border="0"><tbody><tr><td><div align="left">|&nbsp;&nbsp;欢迎,admin&nbsp;&nbsp;|&nbsp;&nbsp;<a 
      class="table_t" 
      href="../index.html">注销</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:history.go(-1)">后退</a>&nbsp;&nbsp;|</div></td>
                    <td><div align="center"><a  href="../admin/showusers.html">登录用户管理</a></div></td>
                ...
                <table width="100%" height="70" border="0" cellpadding="0" cellspacing="1">
                  <tbody>
                    <tr>
                      <td width="44%" bgcolor="#f3f3f3" align="center"><font color="#CC0033" size="4">修改成功</font></td>
