	  ...
	  <jsp:include page="top_nav.jsp"></jsp:include>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1">
                  <tbody>
                    ...
                    <tr>
                      <td width="150" align="center" bgcolor="#f3f3f3">${u.categoryid}</td>
                      <td width="342" align="center" bgcolor="#f3f3f3"><a href="unit/viewprojectinfo1.jsp">${u.projectname}</a></td>
                      <td align="center" bgcolor="#f3f3f3"><a href="unit/viewprojectinfo.jsp">${u.status}</a></td>
                    </tr>
                    </c:forEach>
                  </tbody>
                </table>
