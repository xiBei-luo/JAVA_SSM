...
CREATE TABLE `category_unit` (
  ...
  CONSTRAINT `FK_category_categoryunit` FOREIGN KEY (`categoryid`) REFERENCES `project_category` (`categoryid`) ON DELETE CASCADE,
  CONSTRAINT `FK_unit_categoryunit` FOREIGN KEY (`unitid`) REFERENCES `unit` (`unitid`) ON DELETE CASCADE
...
CREATE TABLE `expert` (
  ...
  CONSTRAINT `FK_user_expert` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE CASCADE
...
INSERT INTO `expert` VALUES (1,2,'郭锐','中国','男','亚思晟','特级教师','110',NULL,NULL,NULL,NULL,NULL),(2,5,'专家test','中国','女','单位测试','工程师','123456','测试修改专家信息',NULL,NULL,NULL,NULL),(3,2,'郭锐','中国','男','亚思晟','特级教师','110',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `project` (
  ...
  CONSTRAINT `FK_category_project` FOREIGN KEY (`categoryid`) REFERENCES `project_category` (`categoryid`) ON DELETE CASCADE,
  CONSTRAINT `FK_unit_project` FOREIGN KEY (`unitid`) REFERENCES `unit` (`unitid`) ON DELETE CASCADE
...
CREATE TABLE `project_category` (
  ...
  CONSTRAINT `FK_expert_category` FOREIGN KEY (`expertid`) REFERENCES `expert` (`expertid`) ON DELETE CASCADE
...
CREATE TABLE `unit` (
  ...
  CONSTRAINT `FK_user_unit` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE CASCADE
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `FK_usergroup_user` FOREIGN KEY (`gid`) REFERENCES `usergroup` (`gid`) ON DELETE CASCADE
...
CREATE TABLE `useradmin` (
  ...
  CONSTRAINT `FK_user_useradmin` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE CASCADE
