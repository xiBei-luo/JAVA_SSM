...
CREATE TABLE project (
  ...
  filldate date default NULL COMMENT '填报时间',
  ...
  expertopinion varchar(500) default NULL COMMENT '专家评审意见',
...
CREATE TABLE category (
  ...
  repstarttime date default NULL COMMENT '单位申报开始时间',
  repstoptime date default NULL COMMENT '单位申报结束时间',
  expstarttime date default '1997-01-01' COMMENT '专家审批开始时间',
  expstoptime date default '1997-01-01' COMMENT '专家审批结束时间',
